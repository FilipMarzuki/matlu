/**
 * Biome definitions for the Matlu Codex wiki.
 *
 * This is a copy of src/world/biomes.ts kept inside the wiki package so that
 * the Astro build works on Vercel — the wiki project is built in an isolated
 * directory and cannot reach the game source via relative paths.
 *
 * When biomes change in the game, update both files.
 */
